    ...
    <main className="min-h-screen pt-40 pb-20 bg-ghost">
      <div className="px-12 md:px-24 max-w-7xl mx-auto">
        ...
        <h1 className="text-navy text-4xl md:text-7xl mt-6 mb-20 leading-tight font-serif">
          The King & Meyer Doctrine:<br />Majority Control, Structural Durability.
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-24 items-start">
          <div className="space-y-16">
            <section>
              ...
              <p className="text-navy text-lg leading-relaxed font-light">
                We do not invest in "potential." We invest in Systems of Conviction. King & Meyer was established to solve a specific market failure: the lack of institutional-grade capital architecture for high-stakes, high-intensity operators.
              </p>
            </section>
            ...
            <section className="bg-navy text-white p-12 border border-navy/10">
              ...
              <p className="text-slate-300 text-lg leading-relaxed font-light italic">
                We operate with a principal-first logic. King & Meyer maintains majority control and IP ownership across all strategic verticals. We do not seek passive participation; we exercise the authority to enforce discipline, ensure capital preservation, and drive asset-backed compounding.
              </p>
            </section>
          </div>
          ...
          <div className="pt-12 md:pt-0">
             <section className="border-l border-gold pl-12">
              ...
              <p className="text-navy text-lg leading-relaxed font-light">
                Our capital allocation is driven by rapid pattern synthesis and high-velocity execution. We identify structural inefficiencies across market pricing and essential infrastructure (Healthcare, Quantitative Finance, Compute) before they are priced in by traditional institutions. We do not avoid intensity; we institutionalise it.
              </p>
